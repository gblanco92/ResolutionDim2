...
I0 := ideal<R | x^5*y - y^3, x^8 + 2*x^5*y>;
II0 := ideal<R | x^5*y - y^3, x*(y^2 - x^5)*(y - x^2), x*y*(y - x^2)^2, x*y^2*(y - x^2)>;
J0 := ideal<Q | x^5*y - y^3, x^8 + 2*x^5*y>;
JJ0 := ideal<Q | x^5*y - y^3, x*(y^2 - x^5)*(y - x^2), x*y*(y - x^2)^2, x*y^2*(y - x^2)>;

I1 := ideal<R | Derivative(v1, 1), Derivative(v1, 2)>;
II1 := ideal<R | y^3 - x^5, (y^2 - x^3)*x^2, y^2*x^2, (y^2 - x^3)*x*y>;
J1 := ideal<Q | Derivative(v1, 1), Derivative(v1, 2)>;
JJ1 := ideal<Q | y^3 - x^5, (y^2 - x^3)*x^2, y^2*x^2, (y^2 - x^3)*x*y>;

I2 := ideal<R | Derivative(v2, 1), Derivative(v2, 2)>;
II2 := ideal<R | y*(y^2 - 3/2*x^3), (y^2 - x^3)*x^2, y^2*x^2, (y^2 - x^3)*x*y>;
J2 := ideal<Q | Derivative(v2, 1), Derivative(v2, 2)>;
JJ2 := ideal<Q | y*(y^2 - 3/2*x^3), (y^2 - x^3)*x^2, y^2*x^2, (y^2 - x^3)*x*y>;
